...
% Separate attributes & labels
X_l = [X_l, ones(size(X_l, 1), 1)]; % 1 for Loss
acc = test(Pxy, parents, [X_w; X_l]);
Py = Pxy{17, 1};
Pxy = Pxy(1:16, :);
save BN Py Pxy parents;
end
